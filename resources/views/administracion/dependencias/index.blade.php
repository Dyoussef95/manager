<x-app-layout>
    ...
    <a class="btn btn-primary py-2" href="{{ route('dependencias.create')}}"> Dar de alta nueva Dependencia / Departamento</a>
        ...
        <table class="table table-striped table-sm" id="myTable">
          ...
          @forelse ($dependencias as $dependencia)
            <tr>
              ...
              <td>
              <a href="{{ route('dependencias.edit', $dependencia->id )}}" class="btn btn-success btn-sm">Editar</a>
              </td>
              <td>
              <form method="POST" action="{{ route('dependencias.destroy', $dependencia->id )}}">
                @method('DELETE')
                @csrf
